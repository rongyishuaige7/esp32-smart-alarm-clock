...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype-redacted.jpg` | 2026-04-06 | EXIF/GPS and other image metadata removed; resized from a copy; visible private/local information obscured | Historical prototype/App photo; the private LAN URL on the phone was obscured. |
| `hardware/eda/schematic.pdf` | Export supplied 2026-07-18 | PDF metadata removed from a copy | Historical schematic/BOM export; not current-commit hardware evidence. |
| `hardware/eda/bom-export.csv` | Export supplied 2026-07-18 | Converted from UTF-16LE tabular export to UTF-8 CSV; supplier/store/price fields omitted | Historical schematic/BOM export; not current-commit hardware evidence. |
